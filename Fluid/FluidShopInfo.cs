...
namespace Fluid
{
    public class FluidShopInfo
    {
        ...
        {
            return new int[] { 9, 10, 11, 12, 13, 14, 15, 182, 16, 17, 18, 19, 20, 21, 29, 30, 31, 34, 35, 36, 22, 32, 33, 0, 1, 2, 3, 4, 6, 7, 8, 26, 27, 28, 23, 24, 25, 100, 101, 5, 500, 501, 502, 503, 504, 505, 506, 507, 508, 509, 510, 511, 512, 411, 412, 413, 414, 1005, 1006, 1007, 1008, 1009, 1010, 408, 409, 410 };
        }
